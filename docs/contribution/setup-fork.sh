...
# upstream   https://github.com/Protactin96/ProxmoxVE.git (fetch)
# upstream   https://github.com/Protactin96/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/Protactin96/ProxmoxVE"
echo ""
