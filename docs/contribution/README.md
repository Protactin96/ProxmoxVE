...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/Protactin96/ProxmoxVE → Fork (top right)
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Protactin96/ProxmoxVE/main/ct/myapp.sh)"
...
git remote add upstream https://github.com/Protactin96/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/Protactin96/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/Protactin96/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/Protactin96/ProxmoxVE/discussions)
